# $KILLSWITCH Protocol - Enterprise Edition Pricing Strategy
...
The $KILLSWITCH Protocol offers a dual-tier solution:
...
- 10K $KILLSWITCH: 10% off
- 100K $KILLSWITCH: 20% off
...
## Token Utility for Enterprise

**Note:** Token holders DO NOT get discounts on Enterprise Edition.

**Instead, token holders receive:**
- 2x governance voting power
- Priority access to new features
- Early beta access to SPIFFE upgrades
- Revenue share via staking

**Staking Rewards:**
- 5% of Enterprise revenue → staking pool
- Base APY: 8%
- Enterprise revenue share: 4-12%
- **Total projected APY: 12-20%**
...
| Feature | Open Source | $KILLSWITCH |
|---------|-------------|-------------|
...
| Feature | Competitors | $KILLSWITCH |
|---------|-------------|-------------|
